...
if(show_replace)
{out+='<h4 id="tipue_search_warning">'+tipuesearch_string_2+' '+d+'. '+tipuesearch_string_3+' <a id="tipue_search_replaced">'+d_r+'</a></h4>';}
if(c==1)
{out+='<h4 id="tipue_search_results_count">Your search for <strong>'+htmlEncode(getParameterByName('q'))+'</strong> had <strong>1</strong> result.';}
else
{c_c=c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,",");out+='<h4 id="tipue_search_results_count">Your search for <strong>'+htmlEncode(getParameterByName('q'))+'</strong> had <strong>'+c_c+'</strong> '+tipuesearch_string_5;}
if(set.showTime)
...
out+='</h4>';found.sort(function(a,b){return b.score-a.score});var l_o=0;for(var i=0;i<found.length;i++)
{if(l_o>=start&&l_o<set.show+start)
{out+='<hr>';}
{out+='<h3 class="tipue_search_content_title"><a href="'+found[i].url+'"'+tipue_search_w+'>'+found[i].title+'</a></h3>';if(set.debug)
...
{t_d+=' ...';}
t_d=t_d.replace(/h0011/g,'tipue_search_content_bold');out+='<p class="tipue_search_content_text">'+t_d+'</p>';}}
l_o++;}
...
{out+='<h4 id="tipue_search_warning">'+tipuesearch_string_8+'</h4>';}}
else
{if(show_stop)
{out+='<h4 id="tipue_search_warning">'+tipuesearch_string_8+'. '+tipuesearch_string_9+'</h4>';}
else
{out+='<h4 id="tipue_search_warning">'+tipuesearch_string_10+'</h4>';if(set.minimumLength==1)
{out+='<h4 id="tipue_search_warning">'+tipuesearch_string_11+'</h4>';}
else
{out+='<h4 id="tipue_search_warning">'+tipuesearch_string_12+' '+set.minimumLength+' '+tipuesearch_string_13+'</h4>';}}}
