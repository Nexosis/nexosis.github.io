...
> See [our guide](/guides/regression) for a quick overview of the process. We'll be using the [Auto MPG Data Set from UC Irvine](http://archive.ics.uci.edu/ml/datasets/Auto+MPG)<sup>1</sup> for this tutorial. You can download a prepared JSON version from our public repository at [https://s3.us-east-2.amazonaws.com/nexosis-api-sample-data/auto-mpg.data.json](https://s3.us-east-2.amazonaws.com/nexosis-api-sample-data/auto-mpg.data.json).
